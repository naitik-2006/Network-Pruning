...
def get_loader(root_folder,caption_file,transform,batch_size=32,num_workers=8,shuffle=True,pin_memory=True,train = True):

    dataset = RSCIDData(root_folder,caption_file,transform=transform , train = train)
